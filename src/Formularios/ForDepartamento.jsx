...
function ForDepartamento({ initialData = {}, onSave, onClose }) {
    ...
    useEffect(() => {
        const fetchFinalidades = async () => {
            setLoading(true);
            try {
                const res = await api.get('departamentos/finalidades');
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            const res = await api.post('departamentos/Registrar', payload);
    ...
    const handleEdit = async (e) => {
        ...
        try {
            ...
            const res = await api.put(`departamentos/actualizar/${initialData.id}`, payload);
