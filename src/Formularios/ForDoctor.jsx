...
function ForDoctor({ initialData = {}, onSave, onClose }) {
    ...
    useEffect(() => {
        const fetchCatalogos = async () => {
            ...
            try {
                ...
                const cargosRes = await api.get('doctores/cargos');
                const profesionesRes = await api.get('doctores/profesiones');
    ...
    const handleRegister = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await api.post('doctores/registrar', form);
    ...
    const handleEdit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await api.put(`doctores/actualizar/${initialData.id}`, form);
